...
namespace ShopOnline.Api.Data
{
    public class ShopOnlineDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Cart>().ToTable("S_Carts");
            modelBuilder.Entity<Product>().ToTable("S_Products");
            modelBuilder.Entity<CartItem>().ToTable("S_CartItems");
            modelBuilder.Entity<ProductCategory>().ToTable("S_ProductCategorys");
            //Products
            //Beauty Category
