    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_S_CartItems", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_S_ProductCategorys", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_S_Products", x => x.Id);
                    table.ForeignKey(
                        name: "FK_S_Products_S_ProductCategorys_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "S_ProductCategorys",
                        principalColumn: "Id",
